...
> **Version:** 1.11 · **Last updated:** 2026-07-19 · **Current phase:** Phase 5 complete; Phase 6 (serving) next
...
**Not started:** §6 Phases 6–7. No dashboard yet. (Phase 6 note: the transform DAG's next Dataset-triggered run and one scheduled ingest with the 7-day lookback still deserve a live observation — the mechanisms are Phase 3/4-verified, but the lookback window is new code on the scheduled path.)
